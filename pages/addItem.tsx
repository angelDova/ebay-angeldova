...
function addItem({}: Props) {
  ...
  const mintNFT = async (e: FormEvent<HTMLFormElement>) => {
    ...
    const metadata = {
      ...
      descrition: target.description.value,
    ...
    try {
      ...
      const nft = await tx.data(); // (optional) fetch data of minted NFT
      ...
      <main className="max-w-6xl mx-auto p-10 border">
        ...
        <div className="flex flex-col justify-center items-center md:flex-row md:space-x-5 pt-5">
          ...
          >
            ...
            <button
              type="submit"
              className="bg-blue-600 font-bold text-white rounded-full py-4 px-10 w-56 mt-10 md:mt-auto mx-auto md:ml-auto"
            >
              Add/Mint Item
            </button>
          </form>
