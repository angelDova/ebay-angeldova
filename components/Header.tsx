  ...
  return (
    <div className="max-w-6xl mx-auto p-2">
      ...
      <section className="flex items-center space-x-2 py-5">
        <div className="h-16 w-16 sm:w-26 md:w-44 cursor-pointer flex-shrink">
          <Link href="/">
            <Image
        ...
        <div className="flex items-center space-x-2 px-2 md:px-5 py-2 border-black border-2 flex-1">
          ...
          <input
            className="flex-1 btn btn:focus"
            placeholder="Search for Anything"
            type="text"
          />
        </div>

        <button className="hidden sm:inline bg-blue-600 text-white px-5 md:px-10 py-2 rounded-full border-1 border-blue-600">
          Search
        </button>

        <Link href="/create">
          <button className="border-2 border-blue-600 px-5 md:px-10 py-2 rounded-full  text-blue-600 hover:bg-blue-600/50 hover:text-white cursor-pointer">
            List Item
          </button>
        </Link>
      </section>
